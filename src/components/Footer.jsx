  ...
  return (
    <div className='w-full flex flex-col md:flex-row justify-between items-start h-screen bg-white p-6 md:p-20'>
        ...
        <div className="inline-block">
          ...
          <div className="mt-4 flex flex-col gap-2 items-start">
            ...
            <div className="flex justify-between items-center w-full">
              <span className="text-base md:text-lg text-black font-thin tracking-wide">
                sportly.se
              </span>
            ...
            >
              <p className="text-base md:text-lg text-black font-thin leading-relaxed max-w-xl">
                En av de bästa i laget! Stort engagemang och närvaro. Tack för
                ditt medverkande!
              </p>
            </div>
      ...
      <div className='w-full md:w-auto flex flex-col gap-4 text-right mt-10 md:mt-28'>
        <h1 className='text-[10vw] md:text-[5vw] font-semibold uppercase leading-none text-black'>
          Contact
        </h1>
